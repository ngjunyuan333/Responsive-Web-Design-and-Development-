...
<center><h1> ADD NEW PACKAGES </h1></center>
<div class = "view">
    ...
    <div class = "container">
        ...
        <div class = "picturecontainer">
            <form action = "addPackage.php" method = "POST">
                <center><select class = "input" name="region" required = "required">
                ...
                <input id="pack_img" class="input" type="file" name="package_image" accept="image/*" required><br>
                <label for="hotel_img">HOTEL IMAGE:</label>
                <input id="hotel_img" class="input" type="file" name="hotel_picture" accept="image/*" required><br>
                <label for="location_img">LOCATION IMAGE:</label>
                <input id="location_img" class="input" type="file" name="location_picture" accept="image/*" required><br>
                <label for="bus_img">BUS IMAGE:</label>
                <input id="bus_img" class="input" type="file" name="bus_picture" accept="image/*" required><br>
                <label for="plane_img">PLANE IMAGE:</label>
                <input id="plane_img" class="input" type="file" name="plane_picture" accept="image/*" required><br>
                
            </div>
            <div class = "detailscontainer">
                <input class = "input" type = "text" name="hotel_details" placeholder="Hotel Details" required>
                <input class = "input" type = "text" name="location_details" placeholder="Location Details" required>
                <input class = "input" type = "text" name="bus_details" placeholder="Bus Details" required>
                <input class = "input" type = "text" name="plane_details" placeholder="Plane Details" required>
                <input class = "input" type = "number" name="package_price" placeholder="Package Price "required>
                <input class = "input" type = "text" name="package_name" placeholder="Package Name" required>
                <input class = "input" type = "text" name="package_details" placeholder="Package Details" required>
                <button type="submit" class="subButton"><font color="white">Add</font></button>
            </div>
        </form>
    </div>
</div>
